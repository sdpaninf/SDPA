...
extern SDPA_INT IZERO   ; // =  0;
extern SDPA_INT IONE    ; // =  1;
extern SDPA_INT IMONE   ; // = -1;
...
for (SDPA_INT dset_i=0,dset_index = 0; dset_i<dset_length; ++dset_i) { \
