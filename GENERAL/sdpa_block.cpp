...
void BlockStruct::initialize(SDPA_INT nBlock)
{
  this->nBlock = nBlock;
  NewArray(blockStruct,SDPA_INT,nBlock);
  NewArray(blockType, BlockType, nBlock);
  NewArray(blockNumber,SDPA_INT,nBlock);
  SDP_nBlock       = 0;
  SDP_blockStruct  = NULL;
  SOCP_nBlock      = 0;
  SOCP_blockStruct = NULL;
...
void BlockStruct::makeInternalStructure()
{
  ...
  NewArray(SDP_blockStruct, SDPA_INT,SDP_nBlock);
  NewArray(SOCP_blockStruct,SDPA_INT,SOCP_nBlock);
