...
public:
  ...
  void setParameterMaxIteration(SDPA_INT maxIteration);
  ...
  void setNumThreads(SDPA_INT NumThreads=0);

  ParameterType getParameterType();
  SDPA_INT    getParameterMaxIteration();
  ...
  SDPA_INT getNumThreads();
  
  void inputConstraintNumber(SDPA_INT m);
  void inputBlockNumber(SDPA_INT nBlock);
  void inputBlockSize(SDPA_INT l, SDPA_INT size);
  void inputBlockType(SDPA_INT l, ConeType coneType);
  void inputCVec(SDPA_INT k, double value);
  void inputElement(SDPA_INT k, SDPA_INT l, SDPA_INT i, SDPA_INT j, double value,
		    bool inputCheck = false);
  void inputInitXVec(SDPA_INT k, double value);
  void inputInitXMat(SDPA_INT l, SDPA_INT i, SDPA_INT j, double value);
  void inputInitYMat(SDPA_INT l, SDPA_INT i, SDPA_INT j, double value);
  ...
  double* getResultXMat(SDPA_INT l);
  double* getResultYMat(SDPA_INT l);
  double getPrimalObj();
  double getDualObj();
  double getPrimalError();
  double getDualError();
  double getDigits();
  SDPA_INT    getIteration();
  double getMu();
  ...
  SDPA_INT      getConstraintNumber();
  SDPA_INT      getBlockNumber();
  SDPA_INT      getBlockSize(SDPA_INT l);
  ConeType getBlockType(SDPA_INT l);
