...
{
  double ret = 0.0;
  SDPA_INT nDim = b.nDim;
  for (SDPA_INT k=0; k<nDim; ++k) {
...
{
  double ret = 0.0;
  SDPA_INT SDP_sp_nBlock  = C.SDP_sp_nBlock;
  SDPA_INT SOCP_sp_nBlock = C.SOCP_sp_nBlock;
  SDPA_INT LP_sp_nBlock   = C.LP_sp_nBlock;
			  ...
			  BlockVector& aVec, BlockVector& bVec)
{
  ...
  ret = 0.0;
  double tmp_ret;
  for (SDPA_INT l=0; l<aVec.nBlock; ++l) {
			  ...
			  SparseMatrix& aMat, DenseMatrix& bMat)
{
  ...
  case SparseMatrix::SPARSE:
    ...
    #if 0
    for (SDPA_INT index=0; index<aMat.NonZeroCount; ++index) {
      #if DATA_CAPSULE
      SDPA_INT        i = aMat.DataS[index].vRow;
      SDPA_INT        j = aMat.DataS[index].vCol;
      double value = aMat.DataS[index].vEle;
      #else
      SDPA_INT        i = aMat.row_index   [index];
      SDPA_INT        j = aMat.column_index[index];
    ...
    for (SDPA_INT index=0; index<amari; ++index) {
      #if DATA_CAPSULE
      SDPA_INT        i = aMat.DataS[index].vRow;
      SDPA_INT        j = aMat.DataS[index].vCol;
      double value = aMat.DataS[index].vEle;
    ...
    for (SDPA_INT index=amari,counter = 0;
	 counter < shou ; ++counter, index+=4) {
      #if DATA_CAPSULE
      SDPA_INT        i1 = aMat.DataS[index].vRow;
      SDPA_INT        j1 = aMat.DataS[index].vCol;
      double value1 = aMat.DataS[index].vEle;
      #else
      SDPA_INT        i1 = aMat.row_index   [index];
      SDPA_INT        j1 = aMat.column_index[index];
	...
	ret1 = value1*(bMat.de_ele[i1+bMat.nRow*j1]
      ...
      #if DATA_CAPSULE
      SDPA_INT        i2 = aMat.DataS[index+1].vRow;
      SDPA_INT        j2 = aMat.DataS[index+1].vCol;
      double value2 = aMat.DataS[index+1].vEle;
      #else
      SDPA_INT        i2 = aMat.row_index   [index+1];
      SDPA_INT        j2 = aMat.column_index[index+1];
	...
	ret2 = value2*(bMat.de_ele[i2+bMat.nRow*j2]
      ...
      #if DATA_CAPSULE
      SDPA_INT        i3 = aMat.DataS[index+2].vRow;
      SDPA_INT        j3 = aMat.DataS[index+2].vCol;
      double value3 = aMat.DataS[index+2].vEle;
      #else
      SDPA_INT        i3 = aMat.row_index   [index+2];
      SDPA_INT        j3 = aMat.column_index[index+2];
	...
	ret3 = value3*(bMat.de_ele[i3+bMat.nRow*j3]
      ...
      #if DATA_CAPSULE
      SDPA_INT        i4 = aMat.DataS[index+3].vRow;
      SDPA_INT        j4 = aMat.DataS[index+3].vCol;
      double value4 = aMat.DataS[index+3].vEle;
      #else
      SDPA_INT        i4 = aMat.row_index   [index+3];
      SDPA_INT        j4 = aMat.column_index[index+3];
...
bool Lal::getCholesky(DenseMatrix& retMat,DenseMatrix& aMat)
{
  ...
  SDPA_INT length,info,shou,amari;
  switch (retMat.type) {
  case DenseMatrix::DENSE:
    ...
    #if 0
    for (SDPA_INT j=0; j<retMat.nCol; ++j) {
      for (SDPA_INT i=0; i<j; ++i) {
    ...
    for (SDPA_INT j=0; j<retMat.nCol; ++j) {
      shou  = j/4;
      amari = j%4;
      for (SDPA_INT i=0; i<amari; ++i) {
	retMat.de_ele[i+retMat.nCol*j] = 0.0;
      }
      for (SDPA_INT i=amari,count=0; count < shou; ++count, i+=4) {
	retMat.de_ele[i+retMat.nCol*j] = 0.0;
...
// aMat = L L^T 
bool Lal::getCholesky(SparseMatrix& aMat, SDPA_INT* diagonalIndex)
{
  SDPA_INT nDIM = aMat.nRow;
  SDPA_INT indexA1,indexA2,indexB2;
  SDPA_INT i,k1,k2,k3;
  // double tmp,tmp2;
  // SDPA_INT tmp3;
  ...
  for (i=0 ; i<nDIM ; ++i) {
	...
	const SDPA_INT tmp3 = aMat.column_index[k2];
	for (; k3<indexB2 ; ++k3) {
...
bool Lal::getSymmetrize(DenseMatrix& aMat)
{
  ...
  case DenseMatrix::DENSE:
    ...
    for (SDPA_INT index = 0; index<aMat.nRow-1; ++index) {
      SDPA_INT index1 = index+index*aMat.nRow + 1;
      SDPA_INT index2 = index+(index+1)*aMat.nRow;
      SDPA_INT length = aMat.nRow - 1 - index;
		       ...
		       DenseMatrix& aMat)
{
  ...
  case DenseMatrix::DENSE:
    #if 0
    for (SDPA_INT i=0; i<aMat.nRow; ++i) {
      for (SDPA_INT j=0; j<=i; ++j) {
	SDPA_INT index1 = i+aMat.nCol*j;
	SDPA_INT index2 = j+aMat.nCol*i;
    ...
    for (SDPA_INT i=0; i<aMat.nRow; ++i) {
      SDPA_INT shou  = (i+1)/4;
      SDPA_INT amari = (i+1)%4;
      for (SDPA_INT j=0; j<amari; ++j) {
	SDPA_INT index1 = i+aMat.nCol*j;
	SDPA_INT index2 = j+aMat.nCol*i;
	retMat.de_ele[index1] = aMat.de_ele[index2];
	retMat.de_ele[index2] = aMat.de_ele[index1];
      }
      for (SDPA_INT j=amari,counter =0 ; counter < shou;
	   ++counter, j+=4) {
	SDPA_INT index1 = i+aMat.nCol*j;
	SDPA_INT index_1 = j+aMat.nCol*i;
	retMat.de_ele[index1] = aMat.de_ele[index_1];
	retMat.de_ele[index_1] = aMat.de_ele[index1];
	SDPA_INT index2 = i+aMat.nCol*(j+1);
	SDPA_INT index_2 = (j+1)+aMat.nCol*i;
	retMat.de_ele[index2] = aMat.de_ele[index_2];
	retMat.de_ele[index_2] = aMat.de_ele[index2];
	SDPA_INT index3 = i+aMat.nCol*(j+2);
	SDPA_INT index_3 = (j+2)+aMat.nCol*i;
	retMat.de_ele[index3] = aMat.de_ele[index_3];
	retMat.de_ele[index_3] = aMat.de_ele[index3];
	SDPA_INT index4 = i+aMat.nCol*(j+3);
	SDPA_INT index_4 = (j+3)+aMat.nCol*i;
...
SDPA_INT Lal::rdpotf2_(char*uplo, SDPA_INT *n, double *a, SDPA_INT *lda, SDPA_INT *info)
{
  SDPA_INT nRow = *lda;
  for (SDPA_INT j = 0; j <*n; ++j) {
...
SDPA_INT Lal::rdpotrf_(char *uplo, SDPA_INT *n, double *a, SDPA_INT *lda, SDPA_INT *info)
{
  ...
  *info = 0;
  ...
  SDPA_INT nb = ilaenv_f77(&IONE, (char *)"DPOTRF", (char *)"L", n,
		      &IMONE,&IONE, &IMONE,
  ...
  if (nb <= 1 || nb >= *n) {
    ...
    for (SDPA_INT j = 0; j < *n; j += nb) {
      SDPA_INT jb = min(nb,*n- j);
...
bool Lal::choleskyFactorWithAdjust(DenseMatrix& aMat)
{
  ...
  SDPA_INT info = 1; // info == 0 means success
  SDPA_INT start = 0;
  while (start<aMat.nRow) {
    SDPA_INT N = aMat.nRow - start;
    ...
    if (start<aMat.nRow-1) {
      ...
      for (SDPA_INT j=1; j<=aMat.nRow-1-start; ++j) {
...
#define TUNEUP 0
  ...
  case SparseMatrix::SPARSE:
    ...
    for (SDPA_INT index=amari, counter=0; counter<shou; ++counter, index+=4) {
      #if DATA_CAPSULE
    ...
    for (SDPA_INT index=aMat.NonZeroCount - 1;
    ...
    for (SDPA_INT index=aMat.NonZeroCount - amari - 1,counter=0 ;
	 counter<shou ; ++counter,index-=4) {
      #if DATA_CAPSULE
      i = aMat.DataS[index].vRow;
      j = aMat.DataS[index].vCol;
    ...
    for (SDPA_INT index= aMat.NonZeroCount - 1; index >= 0; --index) {
      #if DATA_CAPSULE
      SDPA_INT        i = aMat.DataS[index].vRow;
      SDPA_INT        j = aMat.DataS[index].vCol;
      double value = aMat.DataS[index].vEle;
		   ...
		   double* scalar)
{
  ...
  case SparseMatrix::SPARSE:
    ...
    if (scalar==NULL) {
      for (SDPA_INT index=0; index<bMat.NonZeroCount; ++index) {
	#if DATA_CAPSULE
	SDPA_INT        i = bMat.DataS[index].vRow;
	SDPA_INT        j = bMat.DataS[index].vCol;
	double value = bMat.DataS[index].vEle;
	#else
	SDPA_INT        i = bMat.row_index   [index];
	SDPA_INT        j = bMat.column_index[index];
		   ...
		   double* scalar)
{
  ...
  case DenseMatrix::DENSE:
    ...
    SDPA_INT count_num;
    count_num = 0;
    for (SDPA_INT i = 0; i < aMat.nRow * aMat.nCol; i++)
      if (aMat.de_ele[i] != 0.0)
	count_num++;
    
    printf("ratio : count / aMat.nRow*aMat.nCol = %d / %d = %lf\n", count_num, aMat.nRow*aMat.nCol, (double)count_num/(aMat.nRow*aMat.nCol));
#endif
			...
			double* scalar)
{
  ...
  case DenseMatrix::DENSE:
    ...
    // The Polong int is the first argument is "Transpose".
			...
			double* scalar)
{
  ...
  case DenseMatrix::DENSE:
    ...
    // The Polong int is the first argument is "NoTranspose".
	       ...
	       double* scalar)
{
  ...
  case SparseMatrix::SPARSE:
    ...
    for (SDPA_INT index=amari,counter=0;
	 counter<shou; ++counter,index+=4) {
      #if DATA_CAPSULE
      SDPA_INT        i1 = bMat.DataS[index].vRow;
      SDPA_INT        j1 = bMat.DataS[index].vCol;
      double value1 = bMat.DataS[index].vEle * (*scalar);
      #else
      SDPA_INT        i1 = bMat.row_index   [index];
      SDPA_INT        j1 = bMat.column_index[index];
	...
	retMat.de_ele[i1+retMat.nCol*i1] += value1;
      ...
      #if DATA_CAPSULE
      SDPA_INT        i2 = bMat.DataS[index+1].vRow;
      SDPA_INT        j2 = bMat.DataS[index+1].vCol;
      double value2 = bMat.DataS[index+1].vEle * (*scalar);
      #else
      SDPA_INT        i2 = bMat.row_index   [index+1];
      SDPA_INT        j2 = bMat.column_index[index+1];
	...
	retMat.de_ele[i2+retMat.nCol*i2] += value2;
      ...
      #if DATA_CAPSULE
      SDPA_INT        i3 = bMat.DataS[index+2].vRow;
      SDPA_INT        j3 = bMat.DataS[index+2].vCol;
      double value3 = bMat.DataS[index+2].vEle * (*scalar);
      #else
      SDPA_INT        i3 = bMat.row_index   [index+2];
      SDPA_INT        j3 = bMat.column_index[index+2];
	...
	retMat.de_ele[i3+retMat.nCol*i3] += value3;
      ...
      #if DATA_CAPSULE
      SDPA_INT        i4 = bMat.DataS[index+3].vRow;
      SDPA_INT        j4 = bMat.DataS[index+3].vCol;
      double value4 = bMat.DataS[index+3].vEle * (*scalar);
      #else
      SDPA_INT        i4 = bMat.row_index   [index+3];
      SDPA_INT        j4 = bMat.column_index[index+3];
	       ...
	       BlockVector& bVec, double* scalar)
{
  ...
  bool total_judge = SDPA_SUCCESS;
  for (SDPA_INT l=0; l<retVec.nBlock; ++l) {
			  ...
			  DenseLinearSpace& bMat)
{
  ...
  for (SDPA_INT l=0; l<aMat.SDP_nBlock; ++l) {
  ...
  for (SDPA_INT l=0; l<aMat.SOCP_nBlock; ++l) {
  ...
  for (SDPA_INT l=0; l<aMat.LP_nBlock; ++l) {
			  ...
			  DenseLinearSpace& bMat)
{
  ...
  // for SDP
  for (SDPA_INT l=0; l<aMat.SDP_sp_nBlock; ++l) {
    SDPA_INT index = aMat.SDP_sp_index[l];
  ...
  // for SOCP
#if 0
  for (SDPA_INT l=0; l<aMat.SOCP_sp_nBlock; ++l) {
    SDPA_INT index = aMat.SOCP_sp_index[l];
  ...
  for (SDPA_INT l=0; l<aMat.LP_sp_nBlock; ++l) {
    SDPA_INT index = aMat.LP_sp_index[l];
	       ...
	       double* scalar)
{
  ...
  for (SDPA_INT l=0; l<retMat.SDP_nBlock; ++l) {
  ...
  for (SDPA_INT l=0; l<retMat.SOCP_nBlock; ++l) {
  ...
  if (scalar == NULL) {
    for (SDPA_INT l=0; l<retMat.LP_nBlock; ++l) {
	       ...
	       double* scalar)
{
  ...
  // for SDP
  for (SDPA_INT l=0; l<bMat.SDP_sp_nBlock; ++l) {
    SDPA_INT index = bMat.SDP_sp_index[l];
  ...
  // for SOCP
#if 0
  for (SDPA_INT l=0; l<bMat.SOCP_sp_nBlock; ++l) {
    SDPA_INT index = bMat.SOCP_sp_index[l];
  ...
  // for LP
  if (scalar == NULL) {
    for (SDPA_INT l=0; l<bMat.LP_sp_nBlock; ++l) {
      SDPA_INT index = bMat.LP_sp_index[l];
      retMat.LP_block[index] = 
