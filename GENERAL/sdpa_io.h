...
{
public:
  static void read(FILE* fpData, FILE* fpout, SDPA_INT& m, char* str);
  static void read(FILE* fpData, SDPA_INT& nBlock);
  ...
  static void read(FILE* fpData, SDPA_INT m,
		   BlockStruct& bs,
  ...
  static void setBlockStruct(FILE* fpData, InputData& inputData,
			     SDPA_INT m, BlockStruct& bs,
                             long position, bool isDataSparse);
  
  // 2008/02/27 kazuhide nakata   
  // without LP_ANonZeroCount
  static void setElement(FILE* fpData, InputData& inputData, SDPA_INT m,
			 BlockStruct& bs,
                         long position, bool isDataSparse);

  static void printHeader(FILE* fpout, FILE* Display);

  static void printOneIteration(SDPA_INT pIteration,
  ...
  static void printLastInfo(SDPA_INT pIteration,
			    AverageComplementarity& mu,
			    RatioInitResCurrentRes& theta,
			    SolveInfo& solveInfo,
			    StepLength& alpha,
