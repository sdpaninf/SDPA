...
// diagonal part of Cholesky matrix is set these inverse.
  static bool getCholesky(SparseMatrix& aMat, SDPA_INT* diagonalIndex);
  ...
  static SDPA_INT rdpotf2_(char*uplo, SDPA_INT *n, double *a, SDPA_INT *lda, SDPA_INT *info);
  static SDPA_INT rdpotrf_(char *uplo, SDPA_INT *n, double *a, SDPA_INT *lda, SDPA_INT *info);
